...
var server = require('net').createServer()
    ...
    , cfg = {
        port: 1337,//you should probobly change this search 'How to choose a port number' to find out why or what to use 
        buffer_size: 2*1024*8, // buffer is allocated per each socket client
        verbose: true
    }
    , _log = function(){
...
server.on('connection', function(socket) {
    ...
    socket.on('data', function(data_raw) { // data_raw is an instance of Buffer as well
        ...
        if ( (start = str.indexOf("__SUBSCRIBE__")) !=  -1   &&   (end = str.indexOf("__ENDSUBSCRIBE__"))  !=  -1) {
            ...
            // dont say hello its breaking my code socket.write('Hello. Noobhub online. \r\n');
